...
{
    platformBuffer->memory = Win32Backbuffer.memory;
    platformBuffer->width  = Win32Backbuffer.width;
    platformBuffer->height = Win32Backbuffer.height;
    platformBuffer->pitch  = Win32Backbuffer.pitch;
}
